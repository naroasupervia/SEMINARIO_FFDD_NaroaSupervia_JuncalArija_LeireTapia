...
# CONCLUSIONES
En conclusión, después de analizar los datos desde distintos puntos de vista, se ve claramente que el suicidio en España no afecta igual a todo el mundo. Por un lado, hay una diferencia muy marcada entre hombres y mujeres, ya que los hombres siempre presentan cifras más altas, tanto en tasas por 100.000 habitantes como en números absolutos. 
...
Con todo lo que hemos visto, podríamos decir que el grupo con mayor riesgo en base a este estudio serían los hombres de Lugo que están en la mediana edad.
