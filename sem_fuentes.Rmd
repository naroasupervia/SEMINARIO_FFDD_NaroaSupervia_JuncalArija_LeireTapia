...
theme_minimal() +
theme(
  # ESTO ES LO NUEVO: Quitamos el texto del eje X porque ya tenemos colores
  ...
  panel.grid.major.x = element_blank() # (Opcional) Quita líneas verticales para limpiar más
) +
